# CA-002 — Prompt and Context Contracts
...
This work package defines the construction requirements for **Prompt and Context Contracts** within **ECARMF-013 — AI Agent and Cognitive Architecture Standard**.
...
### CA-002-0001 — Prompt and Context Contracts Mandatory

Every ECARMF-compliant implementation requiring AI Agent and Cognitive Architecture Standard capabilities shall implement Prompt and Context Contracts.
...
### CA-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Prompt and Context Contracts.
...
### CA-002-0003 — API Contract

The implementation shall expose a versioned REST API for Prompt and Context Contracts.

Minimum endpoints:

```text
POST   /api/v1/prompt-and-context-contracts
GET    /api/v1/prompt-and-context-contracts/{id}
PATCH  /api/v1/prompt-and-context-contracts/{id}
GET    /api/v1/prompt-and-context-contracts/{id}/history
GET    /api/v1/prompt-and-context-contracts/{id}/traceability
```

### CA-002-0004 — Event Contract
...
- PromptandContextContractsCreated
- PromptandContextContractsUpdated
- PromptandContextContractsValidated
- PromptandContextContractsFailed
- PromptandContextContractsArchived

### CA-002-0005 — Validation Contract
...
### CA-002-0006 — AI Construction Contract
