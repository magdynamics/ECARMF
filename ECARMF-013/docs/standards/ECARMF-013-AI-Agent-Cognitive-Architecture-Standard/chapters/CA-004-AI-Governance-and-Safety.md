# CA-004 — AI Governance and Safety
...
This work package defines the construction requirements for **AI Governance and Safety** within **ECARMF-013 — AI Agent and Cognitive Architecture Standard**.
...
### CA-004-0001 — AI Governance and Safety Mandatory

Every ECARMF-compliant implementation requiring AI Agent and Cognitive Architecture Standard capabilities shall implement AI Governance and Safety.
...
### CA-004-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for AI Governance and Safety.
...
### CA-004-0003 — API Contract

The implementation shall expose a versioned REST API for AI Governance and Safety.

Minimum endpoints:

```text
POST   /api/v1/ai-governance-and-safety
GET    /api/v1/ai-governance-and-safety/{id}
PATCH  /api/v1/ai-governance-and-safety/{id}
GET    /api/v1/ai-governance-and-safety/{id}/history
GET    /api/v1/ai-governance-and-safety/{id}/traceability
```

### CA-004-0004 — Event Contract
...
- AIGovernanceandSafetyCreated
- AIGovernanceandSafetyUpdated
- AIGovernanceandSafetyValidated
- AIGovernanceandSafetyFailed
- AIGovernanceandSafetyArchived

### CA-004-0005 — Validation Contract
...
### CA-004-0006 — AI Construction Contract
