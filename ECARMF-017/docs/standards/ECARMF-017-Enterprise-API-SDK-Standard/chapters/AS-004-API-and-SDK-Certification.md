# AS-004 — API and SDK Certification
...
This work package defines the construction requirements for **API and SDK Certification** within **ECARMF-017 — Enterprise API and SDK Standard**.
...
### AS-004-0001 — API and SDK Certification Mandatory

Every ECARMF-compliant implementation requiring Enterprise API and SDK Standard capabilities shall implement API and SDK Certification.
...
### AS-004-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for API and SDK Certification.
...
### AS-004-0003 — API Contract

The implementation shall expose a versioned REST API for API and SDK Certification.

Minimum endpoints:

```text
POST   /api/v1/api-and-sdk-certification
GET    /api/v1/api-and-sdk-certification/{id}
PATCH  /api/v1/api-and-sdk-certification/{id}
GET    /api/v1/api-and-sdk-certification/{id}/history
GET    /api/v1/api-and-sdk-certification/{id}/traceability
```

### AS-004-0004 — Event Contract
...
- APIandSDKCertificationCreated
- APIandSDKCertificationUpdated
- APIandSDKCertificationValidated
- APIandSDKCertificationFailed
- APIandSDKCertificationArchived

### AS-004-0005 — Validation Contract
...
### AS-004-0006 — AI Construction Contract
