...
This work package defines the construction requirements for **Client Generation** within **ECARMF-017 — Enterprise API and SDK Standard**.
...
### AS-003-0001 — Client Generation Mandatory

Every ECARMF-compliant implementation requiring Enterprise API and SDK Standard capabilities shall implement Client Generation.
...
### AS-003-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Client Generation.
...
### AS-003-0003 — API Contract

The implementation shall expose a versioned REST API for Client Generation.

Minimum endpoints:

```text
POST   /api/v1/client-generation
GET    /api/v1/client-generation/{id}
PATCH  /api/v1/client-generation/{id}
GET    /api/v1/client-generation/{id}/history
GET    /api/v1/client-generation/{id}/traceability
```

### AS-003-0004 — Event Contract
...
- ClientGenerationCreated
- ClientGenerationUpdated
- ClientGenerationValidated
- ClientGenerationFailed
- ClientGenerationArchived

### AS-003-0005 — Validation Contract
...
### AS-003-0006 — AI Construction Contract
