...
This work package defines the construction requirements for **SDK Architecture** within **ECARMF-017 — Enterprise API and SDK Standard**.
...
### AS-002-0001 — SDK Architecture Mandatory

Every ECARMF-compliant implementation requiring Enterprise API and SDK Standard capabilities shall implement SDK Architecture.
...
### AS-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for SDK Architecture.
...
### AS-002-0003 — API Contract

The implementation shall expose a versioned REST API for SDK Architecture.

Minimum endpoints:

```text
POST   /api/v1/sdk-architecture
GET    /api/v1/sdk-architecture/{id}
PATCH  /api/v1/sdk-architecture/{id}
GET    /api/v1/sdk-architecture/{id}/history
GET    /api/v1/sdk-architecture/{id}/traceability
```

### AS-002-0004 — Event Contract
...
- SDKArchitectureCreated
- SDKArchitectureUpdated
- SDKArchitectureValidated
- SDKArchitectureFailed
- SDKArchitectureArchived

### AS-002-0005 — Validation Contract
...
### AS-002-0006 — AI Construction Contract
