...
This work package defines the construction requirements for **API Foundation** within **ECARMF-017 — Enterprise API and SDK Standard**.
...
### AS-001-0001 — API Foundation Mandatory

Every ECARMF-compliant implementation requiring Enterprise API and SDK Standard capabilities shall implement API Foundation.
...
### AS-001-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for API Foundation.
...
### AS-001-0003 — API Contract

The implementation shall expose a versioned REST API for API Foundation.

Minimum endpoints:

```text
POST   /api/v1/api-foundation
GET    /api/v1/api-foundation/{id}
PATCH  /api/v1/api-foundation/{id}
GET    /api/v1/api-foundation/{id}/history
GET    /api/v1/api-foundation/{id}/traceability
```

### AS-001-0004 — Event Contract
...
- APIFoundationCreated
- APIFoundationUpdated
- APIFoundationValidated
- APIFoundationFailed
- APIFoundationArchived

### AS-001-0005 — Validation Contract
...
### AS-001-0006 — AI Construction Contract
