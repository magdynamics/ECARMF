...
public static class AuditCategories
{
    ...
    public const string RiskTreatmentOpened = "RiskTreatmentOpened";
    public const string RiskTreatmentUpdated = "RiskTreatmentUpdated";
    ...
    public const string RenewalProgressRecorded = "RenewalProgressRecorded";
    ...
    public const string PhiFieldRevealed = "PhiFieldRevealed";
}
