# CI-002 — Capital Source Modeling
...
This work package defines the construction requirements for **Capital Source Modeling** within **ECARMF-011 — Capital Intelligence Standard**.
...
### CI-002-0001 — Capital Source Modeling Mandatory

Every ECARMF-compliant implementation requiring Capital Intelligence Standard capabilities shall implement Capital Source Modeling.
...
### CI-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Capital Source Modeling.
...
### CI-002-0003 — API Contract

The implementation shall expose a versioned REST API for Capital Source Modeling.

Minimum endpoints:

```text
POST   /api/v1/capital-source-modeling
GET    /api/v1/capital-source-modeling/{id}
PATCH  /api/v1/capital-source-modeling/{id}
GET    /api/v1/capital-source-modeling/{id}/history
GET    /api/v1/capital-source-modeling/{id}/traceability
```

### CI-002-0004 — Event Contract
...
- CapitalSourceModelingCreated
- CapitalSourceModelingUpdated
- CapitalSourceModelingValidated
- CapitalSourceModelingFailed
- CapitalSourceModelingArchived

### CI-002-0005 — Validation Contract
...
### CI-002-0006 — AI Construction Contract
