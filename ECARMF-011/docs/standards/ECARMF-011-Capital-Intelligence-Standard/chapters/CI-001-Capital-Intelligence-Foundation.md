# CI-001 — Capital Intelligence Foundation
...
This work package defines the construction requirements for **Capital Intelligence Foundation** within **ECARMF-011 — Capital Intelligence Standard**.
...
### CI-001-0001 — Capital Intelligence Foundation Mandatory

Every ECARMF-compliant implementation requiring Capital Intelligence Standard capabilities shall implement Capital Intelligence Foundation.
...
### CI-001-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Capital Intelligence Foundation.
...
### CI-001-0003 — API Contract

The implementation shall expose a versioned REST API for Capital Intelligence Foundation.

Minimum endpoints:

```text
POST   /api/v1/capital-intelligence-foundation
GET    /api/v1/capital-intelligence-foundation/{id}
PATCH  /api/v1/capital-intelligence-foundation/{id}
GET    /api/v1/capital-intelligence-foundation/{id}/history
GET    /api/v1/capital-intelligence-foundation/{id}/traceability
```

### CI-001-0004 — Event Contract
...
- CapitalIntelligenceFoundationCreated
- CapitalIntelligenceFoundationUpdated
- CapitalIntelligenceFoundationValidated
- CapitalIntelligenceFoundationFailed
- CapitalIntelligenceFoundationArchived

### CI-001-0005 — Validation Contract
...
### CI-001-0006 — AI Construction Contract
