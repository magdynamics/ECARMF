# II-004 — Interoperability Validation
...
This work package defines the construction requirements for **Interoperability Validation** within **ECARMF-014 — Integration and Interoperability Standard**.
...
### II-004-0001 — Interoperability Validation Mandatory

Every ECARMF-compliant implementation requiring Integration and Interoperability Standard capabilities shall implement Interoperability Validation.
...
### II-004-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Interoperability Validation.
...
### II-004-0003 — API Contract

The implementation shall expose a versioned REST API for Interoperability Validation.

Minimum endpoints:

```text
POST   /api/v1/interoperability-validation
GET    /api/v1/interoperability-validation/{id}
PATCH  /api/v1/interoperability-validation/{id}
GET    /api/v1/interoperability-validation/{id}/history
GET    /api/v1/interoperability-validation/{id}/traceability
```

### II-004-0004 — Event Contract
...
- InteroperabilityValidationCreated
- InteroperabilityValidationUpdated
- InteroperabilityValidationValidated
- InteroperabilityValidationFailed
- InteroperabilityValidationArchived

### II-004-0005 — Validation Contract
...
### II-004-0006 — AI Construction Contract
