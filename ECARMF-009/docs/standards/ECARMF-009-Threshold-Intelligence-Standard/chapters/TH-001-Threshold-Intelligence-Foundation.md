# TH-001 — Threshold Intelligence Foundation
...
This work package defines the construction requirements for **Threshold Intelligence Foundation** within **ECARMF-009 — Threshold Intelligence Standard**.
...
```text
ThresholdIntelligenceFoundation
    ├── Domain Model
    ├── Application Service
    ├── API Contract
...
### TH-001-0001 — Threshold Intelligence Foundation Mandatory

Every ECARMF-compliant implementation requiring Threshold Intelligence Standard capabilities shall implement Threshold Intelligence Foundation.
...
### TH-001-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Threshold Intelligence Foundation.
...
### TH-001-0003 — API Contract

The implementation shall expose a versioned REST API for Threshold Intelligence Foundation.

Minimum endpoints:

```text
POST   /api/v1/threshold-intelligence-foundation
GET    /api/v1/threshold-intelligence-foundation/{id}
PATCH  /api/v1/threshold-intelligence-foundation/{id}
GET    /api/v1/threshold-intelligence-foundation/{id}/history
GET    /api/v1/threshold-intelligence-foundation/{id}/traceability
```

### TH-001-0004 — Event Contract
...
- ThresholdIntelligenceFoundationCreated
- ThresholdIntelligenceFoundationUpdated
- ThresholdIntelligenceFoundationValidated
- ThresholdIntelligenceFoundationFailed
- ThresholdIntelligenceFoundationArchived

### TH-001-0005 — Validation Contract
...
### TH-001-0006 — AI Construction Contract
