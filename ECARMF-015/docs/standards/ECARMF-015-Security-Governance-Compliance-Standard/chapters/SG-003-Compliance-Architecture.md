# SG-003 — Compliance Architecture
...
This work package defines the construction requirements for **Compliance Architecture** within **ECARMF-015 — Security Governance and Compliance Standard**.
...
### SG-003-0001 — Compliance Architecture Mandatory

Every ECARMF-compliant implementation requiring Security Governance and Compliance Standard capabilities shall implement Compliance Architecture.
...
### SG-003-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Compliance Architecture.
...
### SG-003-0003 — API Contract

The implementation shall expose a versioned REST API for Compliance Architecture.

Minimum endpoints:

```text
POST   /api/v1/compliance-architecture
GET    /api/v1/compliance-architecture/{id}
PATCH  /api/v1/compliance-architecture/{id}
GET    /api/v1/compliance-architecture/{id}/history
GET    /api/v1/compliance-architecture/{id}/traceability
```

### SG-003-0004 — Event Contract
...
- ComplianceArchitectureCreated
- ComplianceArchitectureUpdated
- ComplianceArchitectureValidated
- ComplianceArchitectureFailed
- ComplianceArchitectureArchived

### SG-003-0005 — Validation Contract
...
### SG-003-0006 — AI Construction Contract
