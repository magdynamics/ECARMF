...
This work package defines the construction requirements for **Governance Controls** within **ECARMF-015 — Security Governance and Compliance Standard**.
...
### SG-002-0001 — Governance Controls Mandatory

Every ECARMF-compliant implementation requiring Security Governance and Compliance Standard capabilities shall implement Governance Controls.
...
### SG-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Governance Controls.
...
### SG-002-0003 — API Contract

The implementation shall expose a versioned REST API for Governance Controls.
...
PATCH  /api/v1/governance-controls/{id}
GET    /api/v1/governance-controls/{id}/history
GET    /api/v1/governance-controls/{id}/traceability
```

### SG-002-0004 — Event Contract
...
- GovernanceControlsCreated
- GovernanceControlsUpdated
- GovernanceControlsValidated
- GovernanceControlsFailed
- GovernanceControlsArchived

### SG-002-0005 — Validation Contract
...
### SG-002-0006 — AI Construction Contract
