# DI-003 — Recommendation Generation
...
This work package defines the construction requirements for **Recommendation Generation** within **ECARMF-008 — Decision Intelligence Standard**.
...
### DI-003-0001 — Recommendation Generation Mandatory

Every ECARMF-compliant implementation requiring Decision Intelligence Standard capabilities shall implement Recommendation Generation.
...
### DI-003-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Recommendation Generation.
...
### DI-003-0003 — API Contract

The implementation shall expose a versioned REST API for Recommendation Generation.

Minimum endpoints:

```text
POST   /api/v1/recommendation-generation
GET    /api/v1/recommendation-generation/{id}
PATCH  /api/v1/recommendation-generation/{id}
GET    /api/v1/recommendation-generation/{id}/history
GET    /api/v1/recommendation-generation/{id}/traceability
```

### DI-003-0004 — Event Contract
...
- RecommendationGenerationCreated
- RecommendationGenerationUpdated
- RecommendationGenerationValidated
- RecommendationGenerationFailed
- RecommendationGenerationArchived

### DI-003-0005 — Validation Contract
...
### DI-003-0006 — AI Construction Contract
