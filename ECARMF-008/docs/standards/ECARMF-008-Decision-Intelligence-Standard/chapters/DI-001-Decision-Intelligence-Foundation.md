# DI-001 — Decision Intelligence Foundation
...
This work package defines the construction requirements for **Decision Intelligence Foundation** within **ECARMF-008 — Decision Intelligence Standard**.
...
```text
DecisionIntelligenceFoundation
    ├── Domain Model
    ├── Application Service
    ├── API Contract
...
### DI-001-0001 — Decision Intelligence Foundation Mandatory

Every ECARMF-compliant implementation requiring Decision Intelligence Standard capabilities shall implement Decision Intelligence Foundation.
...
### DI-001-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Decision Intelligence Foundation.
...
### DI-001-0003 — API Contract

The implementation shall expose a versioned REST API for Decision Intelligence Foundation.

Minimum endpoints:

```text
POST   /api/v1/decision-intelligence-foundation
GET    /api/v1/decision-intelligence-foundation/{id}
PATCH  /api/v1/decision-intelligence-foundation/{id}
GET    /api/v1/decision-intelligence-foundation/{id}/history
GET    /api/v1/decision-intelligence-foundation/{id}/traceability
```

### DI-001-0004 — Event Contract
...
- DecisionIntelligenceFoundationCreated
- DecisionIntelligenceFoundationUpdated
- DecisionIntelligenceFoundationValidated
- DecisionIntelligenceFoundationFailed
- DecisionIntelligenceFoundationArchived

### DI-001-0005 — Validation Contract
...
### DI-001-0006 — AI Construction Contract
