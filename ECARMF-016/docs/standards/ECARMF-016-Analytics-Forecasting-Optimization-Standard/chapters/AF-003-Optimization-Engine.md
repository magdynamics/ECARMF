...
This work package defines the construction requirements for **Optimization Engine** within **ECARMF-016 — Analytics Forecasting and Optimization Standard**.
...
### AF-003-0001 — Optimization Engine Mandatory

Every ECARMF-compliant implementation requiring Analytics Forecasting and Optimization Standard capabilities shall implement Optimization Engine.
...
### AF-003-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Optimization Engine.
...
### AF-003-0003 — API Contract

The implementation shall expose a versioned REST API for Optimization Engine.

Minimum endpoints:

```text
POST   /api/v1/optimization-engine
GET    /api/v1/optimization-engine/{id}
PATCH  /api/v1/optimization-engine/{id}
GET    /api/v1/optimization-engine/{id}/history
GET    /api/v1/optimization-engine/{id}/traceability
```

### AF-003-0004 — Event Contract
...
- OptimizationEngineCreated
- OptimizationEngineUpdated
- OptimizationEngineValidated
- OptimizationEngineFailed
- OptimizationEngineArchived

### AF-003-0005 — Validation Contract
...
### AF-003-0006 — AI Construction Contract
