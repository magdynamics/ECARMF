# CC-004 — Certification Artifacts
...
This work package defines the construction requirements for **Certification Artifacts** within **ECARMF-020 — Conformance and Certification Standard**.
...
### CC-004-0001 — Certification Artifacts Mandatory

Every ECARMF-compliant implementation requiring Conformance and Certification Standard capabilities shall implement Certification Artifacts.
...
### CC-004-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Certification Artifacts.
...
### CC-004-0003 — API Contract

The implementation shall expose a versioned REST API for Certification Artifacts.

Minimum endpoints:

```text
POST   /api/v1/certification-artifacts
GET    /api/v1/certification-artifacts/{id}
PATCH  /api/v1/certification-artifacts/{id}
GET    /api/v1/certification-artifacts/{id}/history
GET    /api/v1/certification-artifacts/{id}/traceability
```

### CC-004-0004 — Event Contract
...
- CertificationArtifactsCreated
- CertificationArtifactsUpdated
- CertificationArtifactsValidated
- CertificationArtifactsFailed
- CertificationArtifactsArchived

### CC-004-0005 — Validation Contract
...
### CC-004-0006 — AI Construction Contract
