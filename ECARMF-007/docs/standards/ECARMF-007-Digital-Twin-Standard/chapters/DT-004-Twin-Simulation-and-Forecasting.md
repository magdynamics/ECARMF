# DT-004 — Twin Simulation and Forecasting
...
This work package defines the construction requirements for **Twin Simulation and Forecasting** within **ECARMF-007 — Digital Twin Standard**.
...
### DT-004-0001 — Twin Simulation and Forecasting Mandatory

Every ECARMF-compliant implementation requiring Digital Twin Standard capabilities shall implement Twin Simulation and Forecasting.
...
### DT-004-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Twin Simulation and Forecasting.
...
### DT-004-0003 — API Contract

The implementation shall expose a versioned REST API for Twin Simulation and Forecasting.

Minimum endpoints:

```text
POST   /api/v1/twin-simulation-and-forecasting
GET    /api/v1/twin-simulation-and-forecasting/{id}
PATCH  /api/v1/twin-simulation-and-forecasting/{id}
GET    /api/v1/twin-simulation-and-forecasting/{id}/history
GET    /api/v1/twin-simulation-and-forecasting/{id}/traceability
```

### DT-004-0004 — Event Contract
...
- TwinSimulationandForecastingCreated
- TwinSimulationandForecastingUpdated
- TwinSimulationandForecastingValidated
- TwinSimulationandForecastingFailed
- TwinSimulationandForecastingArchived

### DT-004-0005 — Validation Contract
...
### DT-004-0006 — AI Construction Contract
