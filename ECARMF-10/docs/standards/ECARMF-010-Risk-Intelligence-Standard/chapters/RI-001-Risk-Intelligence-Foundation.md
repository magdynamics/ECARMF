# RI-001 — Risk Intelligence Foundation
...
This work package defines the construction requirements for **Risk Intelligence Foundation** within **ECARMF-010 — Risk Intelligence Standard**.
...
### RI-001-0001 — Risk Intelligence Foundation Mandatory

Every ECARMF-compliant implementation requiring Risk Intelligence Standard capabilities shall implement Risk Intelligence Foundation.
...
### RI-001-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Risk Intelligence Foundation.
...
### RI-001-0003 — API Contract

The implementation shall expose a versioned REST API for Risk Intelligence Foundation.

Minimum endpoints:

```text
POST   /api/v1/risk-intelligence-foundation
GET    /api/v1/risk-intelligence-foundation/{id}
PATCH  /api/v1/risk-intelligence-foundation/{id}
GET    /api/v1/risk-intelligence-foundation/{id}/history
GET    /api/v1/risk-intelligence-foundation/{id}/traceability
```

### RI-001-0004 — Event Contract
...
- RiskIntelligenceFoundationCreated
- RiskIntelligenceFoundationUpdated
- RiskIntelligenceFoundationValidated
- RiskIntelligenceFoundationFailed
- RiskIntelligenceFoundationArchived

### RI-001-0005 — Validation Contract
...
### RI-001-0006 — AI Construction Contract
