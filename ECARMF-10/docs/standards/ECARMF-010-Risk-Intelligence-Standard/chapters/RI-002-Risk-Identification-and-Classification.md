# RI-002 — Risk Identification and Classification
...
This work package defines the construction requirements for **Risk Identification and Classification** within **ECARMF-010 — Risk Intelligence Standard**.
...
### RI-002-0001 — Risk Identification and Classification Mandatory

Every ECARMF-compliant implementation requiring Risk Intelligence Standard capabilities shall implement Risk Identification and Classification.
...
### RI-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Risk Identification and Classification.
...
### RI-002-0003 — API Contract

The implementation shall expose a versioned REST API for Risk Identification and Classification.

Minimum endpoints:

```text
POST   /api/v1/risk-identification-and-classification
GET    /api/v1/risk-identification-and-classification/{id}
PATCH  /api/v1/risk-identification-and-classification/{id}
GET    /api/v1/risk-identification-and-classification/{id}/history
GET    /api/v1/risk-identification-and-classification/{id}/traceability
```

### RI-002-0004 — Event Contract
...
- RiskIdentificationandClassificationCreated
- RiskIdentificationandClassificationUpdated
- RiskIdentificationandClassificationValidated
- RiskIdentificationandClassificationFailed
- RiskIdentificationandClassificationArchived

### RI-002-0005 — Validation Contract
...
### RI-002-0006 — AI Construction Contract
