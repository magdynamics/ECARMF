# DO-002 — Infrastructure and Runtime
...
This work package defines the construction requirements for **Infrastructure and Runtime** within **ECARMF-019 — Deployment and Operations Standard**.
...
### DO-002-0001 — Infrastructure and Runtime Mandatory

Every ECARMF-compliant implementation requiring Deployment and Operations Standard capabilities shall implement Infrastructure and Runtime.
...
### DO-002-0002 — Canonical Domain Model

The implementation shall define a canonical domain model for Infrastructure and Runtime.
...
### DO-002-0003 — API Contract

The implementation shall expose a versioned REST API for Infrastructure and Runtime.

Minimum endpoints:

```text
POST   /api/v1/infrastructure-and-runtime
GET    /api/v1/infrastructure-and-runtime/{id}
PATCH  /api/v1/infrastructure-and-runtime/{id}
GET    /api/v1/infrastructure-and-runtime/{id}/history
GET    /api/v1/infrastructure-and-runtime/{id}/traceability
```

### DO-002-0004 — Event Contract
...
- InfrastructureandRuntimeCreated
- InfrastructureandRuntimeUpdated
- InfrastructureandRuntimeValidated
- InfrastructureandRuntimeFailed
- InfrastructureandRuntimeArchived

### DO-002-0005 — Validation Contract
...
### DO-002-0006 — AI Construction Contract
